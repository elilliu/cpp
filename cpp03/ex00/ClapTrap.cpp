...
void	ClapTrap::attack(const std::string& target)
{
	if (this->_energyPoints && this->_hitPoints)
	{
		...
		std::cout << "ClapTrap " << this->_name << " is K.O, it can't attack." << std::endl;
}
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << "ClapTrap " << this->_name << " now has " << this->_hitPoints << " health points." << std::endl;
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (this->_hitPoints && this->_energyPoints)
	{
		this->_hitPoints += amount;
		this->_energyPoints--;
		std::cout << "ClapTrap " << this->_name << " repairs itself with " << amount << " health points." << std::endl;
		std::cout << "ClapTrap " << this->_name << " now has " << this->_hitPoints << " health points and " << this->_energyPoints << " energy points." << std::endl;
	}
	else if (!this->_energyPoints)
		std::cout << "ClapTrap " << this->_name << " doesn't have enough energy points to repair itself." << std::endl;
	else
		std::cout << "ClapTrap " << this->_name << " is K.O, it can't be repaired." << std::endl;
}
